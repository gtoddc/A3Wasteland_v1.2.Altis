...
[
	...
	["Resupply Vehicle", "client\systems\selling\serviceVehicle.sqf", [], 51, false, false, "", "!(vehicle player == player) and (cursortarget iskindof 'Land_CarService_F') and (player distance cursortarget) < 15"],
