...
BoS_NearBase =
{
	...
	_objects = nearestObjects [player, ["Land_SatellitePhone_F"], 5];
...
BoS_Actions =
{
	...
	_unit addAction ["<t color=""#FFE496"">" + "Open Base Menu", BoS_BaseMenu, [cursorTarget], 1, false, false, "", "(vehicle player == player) and (cursortarget iskindof 'Land_SatellitePhone_F') and (player distance cursortarget) < 5"];
};
