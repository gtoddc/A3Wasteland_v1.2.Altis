...
_turrets = ["B_HMG_01_high_F", "B_static_AA_F", "B_static_AT_F", "B_GMG_01_F"];
...
while {true} do
{
	...
	if (dayTime > 4 && dayTime < 20 && {{_currWep == _x} count _launchers > 0 || {_currVeh isKindOf _x} count _turrets > 0}) then
	{
