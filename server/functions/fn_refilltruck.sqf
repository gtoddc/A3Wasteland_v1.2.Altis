...
[
	...
	["itm", ["optic_Aco", "optic_ACO_grn", "optic_MRCO", "optic_Hamr", "optic_Arco", "optic_tws_mg", "optic_DMS"], RANDOM_BETWEEN(2,4)],
	["wep", ["SMG_01_F", "SMG_02_F"], RANDOM_BETWEEN(1,2), RANDOM_BETWEEN(3,5)],
	["wep", ["arifle_Mk20_GL_F", "arifle_TRG21_GL_F", "arifle_Katiba_GL_F", "arifle_MX_GL_F", "LMG_Mk200_F", "LMG_Zafir_F", "MMG_02_black_F", "MMG_01_tan_F"], RANDOM_BETWEEN(2,5), RANDOM_BETWEEN(4,5)],
	["mag", "1Rnd_HE_Grenade_shell", RANDOM_BETWEEN(5,10)],
	["wep", ["srifle_GM6_LRPS_F", "srifle_LRR_LRPS_F","srifle_DMR_05_blk_F","srifle_DMR_02_F"], RANDOM_BETWEEN(1,2), RANDOM_BETWEEN(4,6)],
